...
namespace RepositoryStd.Migrations
{
    ...
    [Migration("20180214194709_modelChange1")]
    partial class modelChange1
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("ModelStd.Advertisements.Price.AgreementPrice", b =>
                {
                    ...
                    b.ToTable("AgreementPrices","ad");
                });

            modelBuilder.Entity("ModelStd.Advertisements.Price.ExchangePrice", b =>
                {
                    b.Property<Guid>("AdId")
                        .HasColumnName("adId");
            ...
            modelBuilder.Entity("ModelStd.Advertisements.Price.InstallmentPrice", b =>
                {
                    b.Property<Guid>("AdId")
                        .HasColumnName("adId");
                    ...
                    b.Property<decimal>("PayPerInstallment")
                        .HasColumnName("PayPerInstallment")
                        .HasColumnType("money");
                    ...
                    b.ToTable("InstallmentPrice","ad");
                });

            modelBuilder.Entity("ModelStd.Advertisements.Price.MortgageAndRentPrice", b =>
                {
                    b.Property<Guid>("AdId")
                        .HasColumnName("adId");
                    ...
                    b.Property<decimal>("RentPayMonth")
                        .HasColumnName("rentPayMonth")
                        .HasColumnType("money");

                    b.HasKey("AdId");

                    b.ToTable("MortgageAndRentPrice","ad");
                });
            ...
            modelBuilder.Entity("ModelStd.Db.Ad.AdAttributeTransportation", b =>
                {
                    ...
                    b.ToTable("AdAttributeTransportations","ad");
                });
            ...
            modelBuilder.Entity("ModelStd.Db.Ad.LetMeKnowAttributeTransportaion", b =>
                {
                    ...
                    b.Property<int?>("MakeYearFrom")
                        .HasColumnName("makeYearFrom");

                    b.Property<int?>("MakeYearTo")
                        .HasColumnName("makeYearto");
                    ...
                    b.ToTable("LetMeKnowAttributeTransportaions","ad");
                });
            ...
            modelBuilder.Entity("ModelStd.Advertisements.Price.AgreementPrice", b =>
                {
                    b.HasOne("ModelStd.Db.Ad.Advertisement")
                        .WithOne("AgreementPrice")
                        .HasForeignKey("ModelStd.Advertisements.Price.AgreementPrice", "AdId")
            ...
            modelBuilder.Entity("ModelStd.Advertisements.Price.ExchangePrice", b =>
                {
                    b.HasOne("ModelStd.Db.Ad.Advertisement")
                        .WithOne("ExchangePrice")
                        .HasForeignKey("ModelStd.Advertisements.Price.ExchangePrice", "AdId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("ModelStd.Advertisements.Price.InstallmentPrice", b =>
                {
                    b.HasOne("ModelStd.Db.Ad.Advertisement")
                        .WithOne("InsatllmentPrice")
                        .HasForeignKey("ModelStd.Advertisements.Price.InstallmentPrice", "AdId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("ModelStd.Advertisements.Price.MortgageAndRentPrice", b =>
                {
                    b.HasOne("ModelStd.Db.Ad.Advertisement")
                        .WithOne("MortgageAndRentPrice")
                        .HasForeignKey("ModelStd.Advertisements.Price.MortgageAndRentPrice", "AdId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("ModelStd.Db.Ad.LetMeKnowAttributeTransportaion", b =>
                {
                    b.HasOne("ModelStd.Db.Ad.Brand", "Brand")
                        .WithMany("LetMeKnowAttributeTransportaion")
                        .HasForeignKey("BrandId")
