...
var HelloWorld = /** @class */ (function () {
    ...
    HelloWorld.prototype.sayHi = function () {
        console.log("Ali says hello world!!!");
    };
    return HelloWorld;
}());
...
var restAnswer = addWithRest(1, 2, 3, 4, 5, 6, 7, 8, 9);
...
enumDemo();
function numberDemo(age, lenghtOfEmployment) {
    console.log("You are " + age + " years old, and you have worked here " + lenghtOfEmployment + " years");
}
numberDemo(35, 7);
...
//# sourceMappingURL=allJsCodeHere.js.map