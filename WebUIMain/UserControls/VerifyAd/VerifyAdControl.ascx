<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VerifyAdControl.ascx.cs" Inherits="WebUIMain.UserControls.VerifyAd.VerifyAdControl" %>
<style type="text/css">
    #container {
        height: 150px;
        width: 150px;
...
<div class="row myLinks">
    ...
    <div class="col-xs-5">
        <div>
            ...
            <br />
            <%--<p>
                    <span id="spanPrice" runat="server">price</span>
                </p>--%>
        </div>
    </div>
    <div class="col-xs-1"></div>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="myRightToLeft">
                    ...
                    <asp:TextBox ID="TextBoxAdStatusId" runat="server" placeholder="1-7">1</asp:TextBox>
                </div>
            </div>
            <div>
                <div class="myRightToLeft">
