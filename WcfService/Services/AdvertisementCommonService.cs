...
using WcfService.ServicePolicy;
...
namespace WcfService.Services
{
    ...
    public class AdvertisementCommonService : IAdvertisementCommonService, IAdvertisementService
    {
        ...
        //This Method Is Called From AJAX and Android
        ...
        private void setRequestIndex(Dictionary<string, string> userInput)
        {
            ...
            {
                if (_response.CustomDictionary != null)
                    _response.CustomDictionary.Add(RequestIndexKey, userInput[RequestIndexKey]);
                else
                {
                    Dictionary<string, string> customDictionary = new Dictionary<string, string>
                    {
                        {RequestIndexKey, userInput[RequestIndexKey]}
                    };
