...
namespace WcfService.Services
{
    ...
    public class AdvertisementTransportationService : IAdvertisementTransportationService, IAdvertisementService, IServiceCommon
    {
        ...
        public AdvertisementTransportationService()
        {
            _advertisementTransportationRepository = Bootstrapper.container.GetInstance<IRepository<AdvertisementTransportation>>();
            _advertisementCommonService = Bootstrapper.container.GetInstance<IAdvertisementCommonService>();
            _transportaionRepository = Bootstrapper.container.GetInstance<ITransportaionRepository>();
            registrationService = new RegistrationService();
        }
